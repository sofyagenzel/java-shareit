...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getAllBookingsByState(long userId, State state, long from, int size) {
    ...
    public ResponseEntity<Object> getAllBookingsByStateAndOwner(long userId, State state, long from, int size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
