...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    Booking findFirstByItemAndStartLessThanEqualAndStatusIsOrderByEndDesc(Item item, LocalDateTime dateMin, StatusBooking statusBooking);

    Booking findFirstByItemAndStartIsAfterAndStatusOrderByStart(Item item, LocalDateTime dateMax, StatusBooking statusBooking);
