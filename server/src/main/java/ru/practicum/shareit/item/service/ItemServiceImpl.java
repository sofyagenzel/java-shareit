...
public class ItemServiceImpl implements ItemService {
    ...
    @Override
    public List<ItemResponseDto> findAll(Long userId, Integer from, Integer size) {
        Pageable pageable;
    ...
    private ItemResponseDto addBookingsCommentsItem(Item itemDto, Long userId) {
        ...
        List<BookingResponseDto> test = bookingRepository.findAll().stream()
                .map(BookingMapper::toBookingResponseDto)
                .collect(Collectors.toList());
        var lastBookings = bookingRepository.findFirstByItemAndStartLessThanEqualAndStatusIsOrderByEndDesc(itemDto, LocalDateTime.now(), StatusBooking.APPROVED);
        ...
        var nextBookings = bookingRepository.findFirstByItemAndStartIsAfterAndStatusOrderByStart(itemDto, LocalDateTime.now(), StatusBooking.APPROVED);
