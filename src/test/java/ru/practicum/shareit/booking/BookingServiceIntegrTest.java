...
public class BookingServiceIntegrTest {
    ...
    void createBookingTest() {
        ...
        ItemDto itemDto = new ItemDto(null, null, null, 1L, "Item", "Item description", true, 1L);
        itemService.createItem(itemDto, 1L);
        BookingDto bookingDto = new BookingDto(1L, start, end, StatusBooking.APPROVED, 1L, 2L, user, item);
